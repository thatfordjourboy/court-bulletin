    ...
    <div className="space-y-3">
      ...
      >
        ...
        <div className="flex">
          <div className="w-[150px] pl-2">
            ...
            <div className="text-xs font-normal leading-none text-[#464646]">{suitNumber}</div>
          </div>
          <div className="w-[200px] px-2">
            <div className="text-[#464646] text-sm font-medium mb-1">Served</div>
            <div className="text-xs font-normal leading-none text-[#464646] w-[160px] h-[15px]">{servedTime} | {formatDate(servedDate)}</div>
          </div>
          <div className="pl-2">
      ...
      <div className="flex gap-3">
        <motion.button 
          ...
          whileTap={{ scale: 0.99 }}
          className="inline-flex items-center gap-2 px-4 py-[6px] border border-[#01292D] text-[#01292D] hover:bg-[#01292D] hover:text-white transition-colors"
        >
          Read online
        ...
        <motion.button 
          whileHover={{ scale: 1.01 }}
          whileTap={{ scale: 0.99 }}
          className="inline-flex items-center gap-2 px-4 py-[6px] bg-[#01292D] text-[#64CCC5] hover:bg-[#064954] transition-colors"
        >
          Download
